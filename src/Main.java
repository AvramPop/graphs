...
//        System.out.println(graph.getWeight(new Edge(5, 3)));
//        System.out.println(graph2.getWeight(new Edge(5, 3)));
//        graph.updateWeight(new Edge(5, 3), 100);
//        System.out.println(graph.getWeight(new Edge(5, 3)));
//        System.out.println(graph2.getWeight(new Edge(5, 3)));
//        graph2.updateWeight(new Edge(5, 3), 10000);
//        System.out.println(graph.getWeight(new Edge(5, 3)));
//        System.out.println(graph2.getWeight(new Edge(5, 3)));

        //System.out.println("loaded successfully");
////        graph.updateWeight(new Edge(5, 3), 7);
//        System.out.println(graph.getWeight(new Edge(5, 3)));
    }
}
